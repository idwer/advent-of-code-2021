...
if __name__ == '__main__':
    print(f'What is the power consumption of the submarine? {solution("test_input")} - using test_input')
    print(f'What is the power consumption of the submarine? {solution("input")}')